  ...
  render() {
      ...
      return (
          <div className="pac-man" style={pacManStyle}>
            <img src={require('./Images/pacman.png')} alt="Pacman" />
              {/* Contenu de Pac-Man */}
  ...
  render() {
      ...
      return (
          <div className="ghost" style={ghostStyle}>
            <img src={require('./Images/pacmanBlueu.png')} alt="Fantôme Bleu" />
              {/* Contenu du fantôme */}
          </div>
      );
  }
...
class Ghost extends React.Component {
  render() {
      ...
      return (
          <div className="ghost" style={ghostStyle}>
            <img src={require('./Images/pacmanRed.png')} alt="Fantôme Rouge" />
              {/* Contenu du fantôme */}
          </div>
      );
  }
